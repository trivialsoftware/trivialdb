...
Model.prototype.save = function(skipValidation)
{
    ...
    return validatePromise.then(function()
    {
        if(self.$dirty)
        {
            ...
            //TODO: Why can't I use this line? It doesn't get the new values...
            //return self.$$db.store(self.id, _.defaults({}, self.$$updates, self.$$values))
            _.assign(self.$$values, self.$$updates);
